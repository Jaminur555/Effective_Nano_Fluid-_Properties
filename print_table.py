...
def _main():
    ...
    if mode == 'd':
        print("Enter nanoparticles name and wt%, one per line (2 lines): ")
        nkey1, phi1 = prompt_particle(" Particle 1 (name wt%):")
        nkey2, phi2 = prompt_particle(" Particle 2 (name wt%):")
        ...
        particle_args = (
            n1['densiy'], n1['Cp'], n1["k"], phi1,
            n2['densiy'], n2['Cp'], n2["k"], phi2,
        )
    else:
        nkey, phi = prompt_particle("Nano-particle name and wt% (name wt%): ")
